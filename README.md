...
- `data/templates/ssp_miles/`, `data/templates/ssp_c3k_a/` — FSPS
  ...
  regenerated by `tools/make_ssp_templates.py` (run it in the env whose
  compiled FSPS carries the library you want; `--check` compares against
  what is shipped without writing).
