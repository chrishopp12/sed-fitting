...
\definecolor{noteorange}{RGB}{180,95,20}
\definecolor{warnred}{RGB}{160,30,30}

\titleformat{\section}{\Large\bfseries\color{headblue}}{\thesection}{1em}{}
\titleformat{\subsection}{\large\bfseries\color{headblue}}{\thesubsection}{1em}{}

\pagestyle{fancy}
\fancyhf{}
\lhead{\small sedfit user manual}
\rhead{\small\thepage}
\renewcommand{\headrulewidth}{0.4pt}

% A shell command block.
\newtcolorbox{cmd}{
  colback=codebg, colframe=codebg, boxrule=0pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  before skip=6pt, after skip=6pt
}

\newtcolorbox{notebox}[1][Note]{
  breakable, colback=noteorange!5, colframe=noteorange,
  boxrule=0.8pt, title=#1, fonttitle=\bfseries\small
}

\newtcolorbox{warnbox}[1][Careful]{
  breakable, colback=warnred!5, colframe=warnred,
  boxrule=0.8pt, title=#1, fonttitle=\bfseries\small
}
...
\title{\vspace{4cm}\Huge\textbf{sedfit}\\[0.6cm]
       \Large User Manual\\[1.2cm]
       \normalsize Photometry in, redshifts out}
\author{}
...
Ready-made conda environments for both spectral libraries live in
\texttt{envs/}:
...
The backslash at the end of a line means ``the command continues on the
next line.'' That works in Anaconda Prompt on Windows and in any macOS or
Linux terminal. You can always type the whole thing on one line instead.
